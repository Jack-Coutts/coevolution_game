...
export const ACTIONS: { id: Intervention; label: string; blurb: string }[] = [
  ...
  { id: 'releasePred', label: 'Release foxes', blurb: 'Add three fed foxes at the edge. The strongest rescue when only a few foxes remain; more hunting pressure otherwise.' },
  ...
  { id: 'illnessPred', label: 'Fox illness', blurb: 'Infect up to six foxes. It spreads for about a week, then fades; slower than a cull but thins foxes further. Can wipe out a small group.' },
]
