 ...
 * knocks it, and distance from the benchmark levers.
 *
 *   npx tsx scripts/pick.ts <candidates.json> [seedsFrom] [nSeeds]
 */
import { readFileSync } from 'node:fs'
import { benchmarkLevers, deriveParams, LEVER_BY_ID, type LeverValues } from '../src/sim/levers'
