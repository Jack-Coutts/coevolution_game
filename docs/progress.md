...
- [x] #8 Add the vole to the simulation and saves. Ships with #9 on branch `vole-play`.
- [x] #9 Make the three-species meadow playable: the Vole meadow in the picker, vole rendering, notes and explanations. Branch `vole-play`.
