...
- [x] #11 Track persistent ecological varieties. [#29](https://github.com/Jack-Coutts/coevolution_game/pull/29)
- [x] #12 Journal with family history and trait changes. Family history and trait-change entries merged in [#22](https://github.com/Jack-Coutts/coevolution_game/pull/22); variety entries [#29](https://github.com/Jack-Coutts/coevolution_game/pull/29)
